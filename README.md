...
> Projet IA — ENSA de Fès | Module : Deep Learning & NLP | A.U. 2025/2026Encadrant : Pr. Oussama EL GANNOUR
...
**Résultat final** : XGBoost avec Pression_News → Accuracy **50,88%****Conclusion** : Validation empirique de l'Hypothèse d'Efficience des Marchés (EMH)
...
Ou directement sur Google Colab, chaque cellule installe ses dépendancesautomatiquement (`!pip install ...`).
...
> ⚠️ **Important** : Le scraping Google News (cellules 25–26) peut prendre**5 à 10 minutes**. L'analyse FinBERT (cellule 27) peut prendre**10 à 15 minutes** selon le GPU disponible.
...
**Importance des variables (XGBoost final)** :RSI (117) > Volume (105) > MACD (92) > ... > Pression_News (24) > sentiment_lagged (5)
...
Mohammed Amine Dahmani numero 7 & Anasse Harki numero 18 — ENSA de Fès, filière 3IACN, A.U. 2025/2026Encadrant : Pr. Oussama EL GANNOUR
